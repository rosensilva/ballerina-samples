...
public function main (string[] args) {
    ...
    try {
        ...
        statusCode = httpRemoteMockCall(localTimeout2, 1000);
        ...
        statusCode = httpRemoteMockCall(localTimeout3, 3000);
...
public function httpRemoteMockCall (int localTimeout, int artificialNetworkDelay) (int) {
    ...
    //Convert artificial delay in milliseconds to seconds
    string endpointUrl = "/delay/" + <string>(artificialNetworkDelay/1000);
    log:printInfo("Response delay for remote procedure call    :" + <string>artificialNetworkDelay + "s");
